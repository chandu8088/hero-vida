...
class VidaApp {
  ...
  triggerAnalyticsEvents() {
    try {
      ...
      const avoidPageLoadEvent = [
        "bookingStatusUrl",
        "purchaseConfigUrl",
        "aadharValidationStatusUrl",
        "profileUrl",
        "preBookingUrl",
        "shortTermTestDriveUrl",
        "longTermTestDriveUrl",
      ...
      switch (pageUrlName) {
        case "testDriveUrl":
          //searchParam is used for testdrive Reschedule on page load/refresh
        ...
        case "loginUrl":
          ...
          break;
        default:
          if (!avoidPageLoadEvent.includes(pageUrlName)) {
            analyticsUtils.trackPageLoad();
          }
          break;
      }
