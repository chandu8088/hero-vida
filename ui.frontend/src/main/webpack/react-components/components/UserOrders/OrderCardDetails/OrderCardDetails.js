                        ...
                        )}
                    {
                      <>
                        <span
                          ...
                          data-tip={userOrder.tooltipConfig.info}
                          data-for={userOrder.tooltipConfig.id}
                        >
                          <i className="icon-information-circle txt-color--orange"></i>
                        </span>
                        <ReactTooltip
                          place={userOrder?.tooltipConfig?.infoPosition}
                          type="warning"
                          effect="solid"
                          id={userOrder.tooltipConfig.id}
                          className="order-card-tooltip"
                        />
                      </>
                    }
                  </h3>
